...
#define LOG(lvl) join_server::logging::LogHolder((lvl))
#define LOG_DEBUG() LOG(join_server::logging::LogLevel::Debug)
#define LOG_INFO() LOG(join_server::logging::LogLevel::Info)
#define LOG_WARNING() LOG(join_server::logging::LogLevel::Warning)
#define LOG_ERROR() LOG(join_server::logging::LogLevel::Error)
